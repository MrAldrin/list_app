...
## Progress / Next Steps
- [ ] Discuss and agree on the testing framework (`pytest`).
- [ ] Discuss the scope of our first tests (e.g., should we start with the database, the business logic, or both?).
